    ...
    <div data-notification class="bx--inline-notification bx--inline-notification--success cas--message-center" role="alert">
        <div class="bx--inline-notification__details">
            ...
            <div class="bx--inline-notification__text-wrapper">
                <p class="bx--inline-notification__title"><spring:message code="screen.logout.header" /></p>
                <p class="bx--inline-notification__subtitle"><spring:message code="screen.logout.success" arguments="${principal.id}"/> <spring:message code="screen.logout.security" /></p>
            </div>
        </div>
    </div>
</div>
